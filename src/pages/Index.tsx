...
import { Brain, MessageSquare, Workflow, Settings, Database, Zap, Shield, BarChart3 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {/* Verticals Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-8">Supported Verticals</h2>
        ...
        {/* Stats Bar */}
        <div className="mt-16 bg-white/80 backdrop-blur-sm rounded-lg p-6 border-0 shadow-lg">
